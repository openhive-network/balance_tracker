...
DECLARE
  ...
  _result    btracker_backend.limit_order_event;
BEGIN
  ...
  ELSIF _op_type_id = _FILL AND _body -> 'value' ->> 'open_owner' IS NOT NULL THEN
  ...
  ELSIF _op_type_id = _FILL AND _body -> 'value' ->> 'current_owner' IS NOT NULL THEN
