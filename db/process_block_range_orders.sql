...
BEGIN
  ...
  --------------------------------------------------------------------------------
  -- 2) Pre-aggregate CREATEs with block_num
  --------------------------------------------------------------------------------
  ...
  --------------------------------------------------------------------------------
  -- 3a) Log and upsert CREATEs using the real block_num
  --------------------------------------------------------------------------------
  ...
  --------------------------------------------------------------------------------
  -- 4) Materialize FILLS with block_num
  --------------------------------------------------------------------------------
  ...
  --------------------------------------------------------------------------------
  -- 5) Log, pending, and apply FILLS using block_num
  --------------------------------------------------------------------------------
  -- log
  INSERT INTO btracker_app.order_event_log(acct, order_id, event_type, block_num)
