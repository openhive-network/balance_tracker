...
BEGIN
  ...
  CREATE INDEX IF NOT EXISTS idx_transfer_stats_by_hour_nai_updatedat ON transfer_stats_by_hour (nai, updated_at);
  CREATE INDEX IF NOT EXISTS idx_transfer_stats_by_day_nai_updatedat ON transfer_stats_by_day (nai, updated_at);
  CREATE INDEX IF NOT EXISTS idx_transfer_stats_by_month_nai_updatedat ON transfer_stats_by_month (nai, updated_at);
END
$$;
